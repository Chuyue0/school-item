...
<body>
<div class="lititle">病虫害名称查询</div>
<form id="pageForm" action="disasterInfoAction_listName" method="post"> 
<div id="params">	
                ...
                <div class="collection">
                	<button>
                		<c:if test="${list.collections eq '0' }"> 
                			<a class="collectionYes" href="collectionsAction_addCollectionsName?id=${list.id}">收藏</a>
                		</c:if>
