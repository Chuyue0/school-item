...
<body>
<div class="lititle">病虫害类型查询</div>
<form id="pageForm" action="disasterInfoAction_listType" method="post"> 
<div id="params">	
                ...
                <div class="collection">
                	<button>
                		<c:if test="${list.collections eq '0' }"> 
                			<a class="collectionYes" href="collectionsAction_addCollectionsType?id=${list.id}">收藏</a>
                		</c:if>
